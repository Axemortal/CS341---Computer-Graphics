...
import {
  ...
  SysRenderNormals,
  SysRenderShadePervertex,
  SysRenderShadePerpixel,
} from "./mesh_render.js";
...
=======
  ...
  const shaders_to_load = [
    "normals.vert.glsl",
    "normals.frag.glsl",
    "shade_pervertex.vert.glsl",
    "shade_pervertex.frag.glsl",
    "shade_perpixel.vert.glsl",
    "shade_perpixel.frag.glsl",
  ];
  for (const shader_name of shaders_to_load) {
    resource_promises[shader_name] = load_text(`./src/${shader_name}`);
  }
  ...
  const meshes_to_load = [
    ...
    "cup2.obj",
    "table.obj",
    "shadow_scene__terrain.obj",
    "shadow_scene__wheel.obj",
  ];
  for (const mesh_name of meshes_to_load) {
    resource_promises[mesh_name] = icg_mesh_load_obj(`./meshes/${mesh_name}`);
  }
