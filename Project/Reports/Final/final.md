...
**Scene Reloading**: Scene Reloading: reloadScene and reloadCityScene clear and reinitialize objects, ensuring that parameter changes apply immediately without full page reloads.
